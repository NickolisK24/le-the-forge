...
2. Next recommended architecture target: create diagnostic policy and validation for the remaining unresolved modifier categories, starting with missing reference mapping or unsupported special behavior. This should preserve provenance and warning metadata before any resolver output changes.
