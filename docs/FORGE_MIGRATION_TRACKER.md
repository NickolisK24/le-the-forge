...
2. Next recommended architecture target: document and validate policy for unsupported special behavior. This should preserve provenance and warning metadata before any resolver output changes.
