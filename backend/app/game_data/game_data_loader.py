...
Data sources:
  /data/items/affixes.json          — generated by scripts/sync_game_data.py from last-epoch-data
  /data/classes/skills_metadata.json  — generated by scripts/sync_game_data.py from last-epoch-data
  /data/entities/enemy_profiles.json   — hand-curated enemy profiles for simulation
...
_AFFIXES_PATH = os.path.join(_ROOT_DIR, "data", "items", "affixes.json")
_ENEMY_PROFILES_PATH = os.path.join(_ROOT_DIR, "data", "entities", "enemy_profiles.json")
_SKILLS_METADATA_PATH = os.path.join(_ROOT_DIR, "data", "classes", "skills_metadata.json")
_UNIQUES_PATH = os.path.join(_ROOT_DIR, "data", "items", "uniques.json")
_RARITIES_PATH = os.path.join(_ROOT_DIR, "data", "items", "rarities.json")
_DAMAGE_TYPES_PATH = os.path.join(_ROOT_DIR, "data", "combat", "damage_types.json")
_IMPLICIT_STATS_PATH = os.path.join(_ROOT_DIR, "data", "items", "implicit_stats.json")
...
def _affixes_raw() -> list:
    """Load the canonical flat affix list from /data/items/affixes.json."""
...
def _uniques_raw() -> dict:
    """Load the curated unique items catalogue from /data/items/uniques.json."""
