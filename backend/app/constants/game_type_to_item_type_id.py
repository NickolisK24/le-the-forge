...
canonical item type ID slugs used throughout the backend constants layer.

Note: multiple game types can map to the same item type ID (e.g. both
...
GAME_TYPE_TO_ITEM_TYPE_ID: dict[str, str] = {
    # Armor
    "HELMET":             "helm",
    "BODY_ARMOR":         "chest",
    "BELT":               "belt",
