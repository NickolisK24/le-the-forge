...
SKILL_STATS: dict = {
    ...
    "Abyssal Echoes":         _S(100, 0.08, 1.43, ["void_damage_pct"], is_spell=True, mana_cost=35),
    "Arcane Ascendance":      _S(0,   0.00, 1.33, []),
    "Armblade Slash":         _S(90,  0.08, 1.33, ["physical_damage_pct"], is_melee=True),
    "Aura Of Decay":          _S(20,  0.06, 1.33, ["poison_damage_pct"]),
    "Banner Rush":            _S(0,   0.00, 1.0,  []),
    "Black Hole":             _S(0,   0.00, 1.33, []),
    "Cinder Strike":          _S(90,  0.08, 1.28, ["fire_damage_pct"], is_melee=True),
    "Create Shadow":          _S(0,   0.00, 1.33, []),
    "Dark Quiver":            _S(0,   0.00, 1.33, []),
    "Decoy":                  _S(55,  0.08, 1.43, ["fire_damage_pct"], is_throwing=True),
    "Detonate Decoy":         _S(0,   0.00, 1.33, []),
    "Dive":                   _S(0,   0.00, 2.5,  ["physical_damage_pct"], is_melee=True),
    "Eterra's Blessing":      _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Evade":                  _S(0,   0.00, 2.0,  []),
    ...
    "Flay":                   _S(130, 0.08, 1.0,  ["physical_damage_pct"], is_melee=True),
    "Focus":                  _S(0,   0.00, 1.33, []),
    "Frigid Tempest":         _S(100, 0.08, 2.0,  ["cold_damage_pct"], is_spell=True),
    "Frost Wall":             _S(0,   0.00, 1.33, []),
    "Ghostflame":             _S(30,  0.08, 5.0,  ["fire_damage_pct"], is_spell=True),
    "Glyph of Dominion":      _S(0,   0.00, 1.33, []),
    "Hammer Throw":           _S(55,  0.08, 1.33, ["physical_damage_pct"], is_throwing=True),
    "Heartseeker":            _S(70,  0.08, 1.33, ["physical_damage_pct"], is_bow=True),
    "Holy Aura":              _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Human Form":             _S(50,  0.08, 3.33, ["spell_damage_pct"], is_spell=True),
    "Ice Barrage":            _S(0,   0.00, 1.33, []),
    "Ice Ward":               _S(0,   0.00, 1.33, []),
    "Lethal Mirage":          _S(130, 0.08, 0.67, ["physical_damage_pct"], is_melee=True),
    "Mark For Death":         _S(0,   0.00, 1.33, []),
    "Maul":                   _S(60,  0.08, 4.0,  ["physical_damage_pct"], is_melee=True),
    "Multistrike":            _S(90,  0.08, 1.33, ["physical_damage_pct"], is_melee=True),
    "Net":                    _S(55,  0.08, 1.11, ["physical_damage_pct"], is_throwing=True),
    "Rampage":                _S(0,   0.00, 1.0,  ["physical_damage_pct"], is_melee=True),
    "Reap":                   _S(0,   0.00, 5.0,  ["necrotic_damage_pct"], is_melee=True),
    "Rebuke":                 _S(30,  0.08, 5.0,  ["spell_damage_pct"], is_spell=True),
    "Ring Of Shields":        _S(60,  0.09, 0.4,  ["physical_damage_pct"]),
    "Riposte":                _S(90,  0.08, 1.33, ["physical_damage_pct"], is_melee=True),
    "Roar":                   _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Rune Bolt":              _S(0,   0.00, 1.33, []),
    "Sacrifice":              _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Shield Bash":            _S(90,  0.08, 1.33, ["physical_damage_pct"], is_melee=True),
    "Shocking Impact":        _S(100, 0.08, 0.5,  ["lightning_damage_pct"], is_spell=True),
    "Spirit Thorns":          _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    ...
    "Swarm Strike":           _S(90,  0.08, 1.25, ["physical_damage_pct"], is_melee=True),
    "Swarmblade Form":        _S(0,   0.00, 1.25, []),
    "Symbols of Hope":        _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Tempest Strike":         _S(90,  0.08, 1.67, ["cold_damage_pct"], is_melee=True),
    "Thorn Shield":           _S(100, 0.08, 1.33, ["spell_damage_pct"], is_spell=True),
    "Upheaval":               _S(90,  0.08, 1.25, ["physical_damage_pct"], is_melee=True),
    "Vengeance":              _S(90,  0.08, 1.33, ["physical_damage_pct"], is_melee=True),
    "Wave of Death":          _S(100, 0.08, 1.33, ["necrotic_damage_pct"], is_spell=True),
}
