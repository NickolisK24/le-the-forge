...
export const CLASS_SKILLS: Record<CharacterClass, SkillDef[]> = {
  ...
  Rogue: [
    // Base skills (available to all Rogue masteries)
    ...
    { name: "Umbral Blades",     tags: ["Physical","Throwing"],               icon: "🗡️" },
    { name: "Shadow Rend",       tags: ["Physical","Melee"],                  icon: "🌑" },
    { name: "Bladestorm",        tags: ["Physical","Throwing"],               icon: "🌀" },
    { name: "Ballista",          tags: ["Totem","Bow","Physical"],            icon: "🎯" },
    { name: "Flay",              tags: ["Physical","Melee"],                  icon: "🗡️" },
    ...
    { name: "Detonating Arrow",  mastery: "Marksman", tags: ["Lightning","Bow"],                   icon: "💥" },
    // Falconer exclusive
    { name: "Explosive Trap",    mastery: "Falconer", tags: ["Fire","Throwing"],                   icon: "💣" },
